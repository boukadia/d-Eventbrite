        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (notifications.length === 0) {
                    ...
                    notificationList.append('<li class="dropdown-item text-center">No new notifications</li>');
                } else {
                    ...
                    notifications.forEach(notification => {
                        notificationList.append(`
                           <a class="dropdown-item flex items-center p-2 hover:bg-gray-100" href="javascript:;">
    <div class="flex items-center">
        <!-- User Avatar -->
        <div class="shrink-0">
            <img src="assets/images/avatars/avatar-8.png" class="w-8 h-8 rounded-full" alt="user avatar">
        </div>
