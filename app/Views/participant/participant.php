    ...
    <div class="sidemenu-content">
      ...
      <div class="widget">
        ...
        <div class="recent-post-wrap">
          ...
          <div class="recent-post">
            <div class="media-img">
              <a href="blog-details.html"><img src="/assets/img/blog/recent-post-1-2.jpg" ?> alt="BlogImage"></a>
            </div>
            <div class="media-body">
              <h4 class="post-title">
                <a class="text-inherit" href="blog-details.html">
          ...
          <div class="recent-post">
            <div class="media-img">
              <a href="blog-details.html"><img src="/assets/img/blog/recent-post-1-3.jpg" ?> alt="BlogImage"></a>
            </div>
            <div class="media-body">
              <h4 class="post-title">
                <a class="text-inherit" href="blog-details.html">
          ...
          <div class="recent-post">
            <div class="media-img">
              <a href="blog-details.html"><img src="/assets/img/blog/recent-post-1-4.jpg" ?> alt="BlogImage"></a>
            </div>
            <div class="media-body">
              <h4 class="post-title">
                <a class="text-inherit" href="blog-details.html">
  ...
  <section>
    <div class="style2 vs-carousel" data-slide-show="1" data-fade="true" data-arrows="false">
      ...
      <div>
        <div class="hero-inner style2">
          <div class="overlay"></div>
          <div class="hero-bg" data-bg-src="/assets/img/bg/h-2-2-2.jpg"></div>
          <img src="/assets/img/shapes/h-1-1.png" alt="shapes" class="hero-shape1">
          <div class="container">
            <div class="justify-content-between row">
    ...
    <div class="container">
      ...
      <div class="fadeInUp filter-active2 row wow" data-wow-delay="0.4s">
        ...
        <div class="Art col-lg-4 col-md-6 Education filter-item Sport">
          <div class="event-style1">
            <div class="event-img">
              <img src="/assets/img/events/e-1-2.jpg"?> alt="e 1 1">
              <div class="event-tags">
        ...
        <div class="Art col-lg-4 col-md-6 Education filter-item More">
          <div class="event-style1">
            <div class="event-img">
              <img src="/assets/img/events/e-1-3.jpg"?> alt="e 1 1">
              <div class="event-tags">
        ...
        <div class="Business col-lg-4 col-md-6 Education Education filter-item">
          <div class="event-style1">
            <div class="event-img">
              <img src="/assets/img/events/e-1-4.jpg"?> alt="e 1 1">
              <div class="event-tags">
                <a href="event-details.html">Education</a>
              </div>
              <div class="event-date">
        ...
        <div class="Business col-lg-4 col-md-6 filter-item More Sport">
          <div class="event-style1">
            <div class="event-img">
              <img src="/assets/img/events/e-1-5.jpg"?> alt="e 1 1">
              <div class="event-tags">
        ...
        <div class="col-lg-4 col-md-6 Festival filter-item Sport">
          <div class="event-style1">
            <div class="event-img">
              <img src="/assets/img/events/e-1-6.jpg"?> alt="e 1 1">
              <div class="event-tags">
